...
import { Mail, Lock, User, Loader2, Sparkles, Clock } from 'lucide-react';
    ...
    return (
      <div className="w-full text-center">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
          ...
          <p className="text-slate-400 text-sm">We sent a confirmation link to <span className="text-white font-medium">{email}</span></p>
          <Link href="/auth/login" className="inline-block mt-6 text-blue-400 hover:text-blue-300 text-sm font-medium transition-colors">
            Back to sign in
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="w-full">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400 mt-1 text-sm">Get started for free</p>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-1.5">How often should we sync your email?</label>
            <div className="relative">
              ...
              <select
                ...
                className="w-full appearance-none bg-white/5 border border-white/10 text-white rounded-lg pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
              >
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white font-medium rounded-lg py-2.5 text-sm transition-all flex items-center justify-center gap-2 mt-2">
